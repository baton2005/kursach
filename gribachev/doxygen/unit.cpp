...
/**
 * @brief Тест для проверки значений по умолчанию CMDParser.
 */
...
/**
 * @brief Тест для проверки анализа аргументов CMDParser.
 */
...
/**
 * @brief Тест для проверки неверных аргументов CMDParser.
 */
...
/**
 * @brief Тест для проверки инициализации ReadWrite.
 */
...
/**
 * @brief Тест для проверки записи вектора в файл.
 */
...
/**
 * @brief Тест для проверки ошибки при записи вектора в файл.
 */
...
/**
 * @brief Тест для проверки чтения векторов из файла.
 */
...
/**
 * @brief Тест для проверки ошибки при чтении векторов из файла.
 */
...
/**
 * @brief Тест для проверки чтения конфигурационного файла.
 */
...
/**
 * @brief Тест для проверки ошибки при чтении конфигурационного файла с неверным форматом.
 */
...
/**
 * @brief Тест для проверки ошибки при чтении конфигурационного файла с неверным путем.
 */
...
/**
 * @brief Тест для проверки хеширования SHA-224.
 */
TEST(SHA224_Hashing)
{
    string data = "hello";
...
/**
 * @brief Тест для проверки хеширования пустой строки SHA-224.
 */
...
/**
 * @brief Тест для проверки хеширования длинной строки.
 */
...
/**
 * @brief Тест для проверки хеширования строки со специальными символами.
 */
...
/**
 * @brief Тест для проверки хеширования числовой строки.
 */
...
/**
 * @brief Тест для проверки хеширования строк с разным регистром.
 */
...
// Тесты для VClient
/**
 * @brief Тест для проверки инициализации VClient.
 */
